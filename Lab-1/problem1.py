...
file = open("C:/Users/User/Desktop/Lab-1/input.txt", "r")
file_element=file.read().split()

for i in range(len(file_element)):
    new_file=open("C:/Users/User/Desktop/Lab-1/output.txt","a")
    if i%2==0:
...
new_file=open("C:/Users/User/Desktop/Lab-1/output.txt","r")
fi=new_file.read()
print(fi)


percentage_file=open("C:/Users/User/Desktop/Lab-1/record.txt","a")
...
percentage_file.write("Percentage of palindrome: "+str((100/(palindrome_count+non_palindrome_count))*non_palindrome_count)+"%\n")
percentage_file.write("Percentage of non palindrome: "+str((100/(palindrome_count+non_palindrome_count))*palindrome_count)+"%\n")
